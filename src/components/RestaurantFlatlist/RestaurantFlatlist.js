...
const RestaurantFlatlist = (item) => {
    ...
    const renderItem = ({item, index}) => {
        return(
            <TouchableHighlight activeOpacity={0.9} underlayColor={"#F5F5F5"} onPress={()=>onHandleRestaurantItemPressed(item, index)}>
                ...
                <View style={styles.flatlistStatStyle}>
                    ...
                    <View style={styles.flatlistItemStat}>
                        ...
                        <Text>  {'\u00B7'}  </Text>
                        <Text style={styles.flatlistDistanceTextItem}>{item.distance}km</Text>
                    </View>
                </View>
                </View>
            </TouchableHighlight>
