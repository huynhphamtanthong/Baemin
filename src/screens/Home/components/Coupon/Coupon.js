...
const Coupon = () => {
    ...
    return(
      <TouchableOpacity style={styles.main} activeOpacity={0.5} onPress={() => onHandleCouponTotalPressed()}>
          <CouponIcon width={60} height={40} style={styles.couponIconStyle}/>
          <Text style={styles.couponTextStyle}>Bạn ơi, {(numberCoupon)} mã giảm giá đang vẫy gọi nè</Text>
