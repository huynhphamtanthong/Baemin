  ...
  return (
    <View style={styles.main}>
      <TouchableOpacity
        ...
        activeOpacity={0.5}
        onPress={() => onHandleAddressIconOnPressed()}
      >
        <AddressIcon width={30} height={30} />
        <Text style={styles.text_address}>129/49A Nguyễn Trãi</Text>
        <RightArrowIcon
          width={10}
          height={10}
      ...
      <TouchableOpacity
        style={styles.mail}
        activeOpacity={0.5}
        onPress={() => onHandleMailIconOnPressed()}
      >
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.5}
        onPress={() => onHandleMenuIconOnPressed()}
      >
